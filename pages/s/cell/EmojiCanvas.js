...
class EmojiCanvas extends Component {
  ...
  render() {
    ...
    const activeEmojiConfig = emojiConfigs.find(
      (config) => config['data-id'] === this.props.activeEmojiId
    )
    ...
    console.log('emojiConfigs', emojiConfigs)
          ...
          <Layer>
            ...
            >
              ...
              <Text
                {...outlineConfig}
                ref={(ref) =>
                  (this.props.emojiRefs[EMOJI_MASK_OUTLINE_REF_ID] = ref)
                }
