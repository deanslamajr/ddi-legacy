...
NREUM.loader_config = {
  accountID: window.__newRelic.accountID,
  trustKey: window.__newRelic.accountID,
  agentID: window.__newRelic.appId,
  licenseKey: window.__newRelic.browserKey,
  applicationID: window.__newRelic.appId,
}
NREUM.info = {
  beacon: 'bam.nr-data.net',
  errorBeacon: 'bam.nr-data.net',
